...
import { selectAllProducts, fetchAllProductsAsync, fetchProductByFiltersAsync } from '../ProductListSlice'
...
export default function ProductList() {
  ...
  const handleclickshowproduct = (e, section, option) => {
    console.log("Event:", e);
  ...
  useEffect(() => {
    const pagination = { _page: page, _limit: 6 };
                                ...
                                {section.options.map((option, optionIdx) => (
                                  <div key={option.value} className="flex items-center">
                                    <input
                                      ...
                                      onClick={e => handleclickshowproduct(e, section, option)}
                                      type="checkbox"
                          ...
                          <Link to="/productdetail">
                            <div key={product.id} className="group relative border-solid border-2 p-2 border-gray-200">
                              ...
                              <div className="mt-4 flex justify-between">
                                ...
                                <div>
                                  <p className="text-sm font-medium text-black-900">${Math.round(product.price * (1 - product.discountPercentage / 100))}</p>
            ...
            <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
              <div>
                <p className="text-sm text-gray-700">
                  Showing <span className="font-medium">{(page - 1) * 30 + 1}</span> to <span className="font-medium">{page * 30}</span> of{' '}
              ...
              <div>
                <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                  ...
                  {Array.from({ length: (30 / 5) }).map((element, index) => (
                    <div
                      key={index}
